...
/// <summary>
/// Testet, ob der TopBottomHeatMode funktioniert.
/// </summary>
public class TopBottomHeatModeTest
{
    ...
    [Fact]
    public void TopBottomHeatMode_ShouldIncreaseTopAndBottomHeaterTemperatureByOne()
    {
        ...
        var mode = new TopBottomHeatMode();
